        ...
        <section className="section">
          <div className="glass-card">
            <div className="flex flex-col gap-5">
              ...
              <p className="body-text">
                Clients may register through Supabase Auth using social or email
              ...
              <p className="body-text">
                ...
                published rate; the platform retains a 40% service fee and the
                remaining 60% is credited to the reader. Balances are stored
